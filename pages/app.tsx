...
import {
    App,
    Article, injectGlobalStyle, Media, Chapter, Toc, P, H1,  A, ColumnList, Module, Section
} from '../src';
injectGlobalStyle();
const navs: App.MNavInputProp[] = [{
                        ...
                        <Article.Content>
                            ...
                            <ColumnList>
                                <Section columns3="three">
                                    ...
                                    <Module>
                                        <Media.Image
                                            src="https://cdn.pixabay.com/photo/2018/06/10/13/51/swan-3466552_960_720.jpg" />
                                    </Module>
                                </Section>
                                <Section columns3="three">
                                    <Module>
